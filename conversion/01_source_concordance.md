...
| **L1112–1117** | **Angle update + normalization** | **Part of rotation** | Adds angular velocity to angle (`mth`), normalizes to ±π by add/sub `311040₈` |
